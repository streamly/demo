            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              <div className="p-8">
                ...
                {hasIncompleteProfile && (
                  <div className={`border rounded-md p-4 mb-6 ${isFromVideoAccess || isFromSignin
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        <h3 className={`text-sm font-medium ${isFromVideoAccess || isFromSignin ? 'text-blue-800' : 'text-amber-800'
                          }`}>
                          {isFromVideoAccess
                        ...
                        <div className={`mt-2 text-sm ${isFromVideoAccess || isFromSignin ? 'text-blue-700' : 'text-amber-700'
                          }`}>
                          <p>
                            {isFromVideoAccess
